...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonInput : vMonoBehaviour
    {
        ...
        public GenericInput rollInput = new GenericInput("W", "B", "B");
        public GenericInput slideInput = new GenericInput("C", "B", "B");
        ...
        public GenericInput crouchInput = new GenericInput("C", "B", "B");
        ...
        protected virtual void InputHandle()
        {
            ...
            if (GameManager.m_GameState == GameState.gamePlay && Time.time - startTime > vThirdPersonCamera.animationDuration)
            {
                MoveInput();
                SprintInput();
                CrouchInput();
        ...
        {
          //  if (GameManager.m_GameState == GameState.gamePlay)
           // {
                if (!cameraMain)
                {
